...
IMAGE2TEXT_BASE_URL = os.getenv(
    "IMAGE2TEXT_BASE_URL", "https://testing.inference-playground.nebiuscloud.net/v1/"
)
IMAGE2TEXT_MODEL = os.environ.get("IMAGE2TEXT_MODEL", DEFAULT_IMAGE2TEXT_MODEL)
CHAT_BASE_URL = os.environ.get("CHAT_BASE_URL", "https://api.studio.nebius.ai/v1")
...
def main():
    ...
    with col1:
        client = OpenAI(base_url=IMAGE2TEXT_BASE_URL)
    ...
    with col2:
        ...
        if st.session_state.assistant:
            client_chat = OpenAI(base_url=CHAT_BASE_URL)
